...
const Hero = () => {
  ...
  return (
   <div className='flex flex-col items-start justify-center pax-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat 
   bg-center bg-cover h-screen'>
    ...
    <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive hoteks and resorts. Start your journey today</p>
