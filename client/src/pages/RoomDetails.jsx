...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        {/*Room Details*/}
      <div className='flex fles-col md:flex-row items-start md:items-center gap-2'>
        <h1 className='text-3xl md:text-4xl font-fiarplay'>{room.hotel.name} <span className='font-inter text-sm'>({room.roomType})</span></h1>
...
<div className='flex flex-col items-start gap-4'>
    ...
    <button
        className='px-6 py-2.5 mt-4 rounded text-white bg-blue-500 hover:bg-primary-dull transition-all cursor-pointer'
    >
        Contact Now
    </button>
</div>   
